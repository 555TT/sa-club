...
import com.xiaoshouwaliang.subject.infra.basic.mapper.SubjectJudgeDao;
...
public class SubjectJudgeServiceImpl implements SubjectJudgeService {
    ...
    @Override
    public void batchInsert(List<SubjectJudge> subjectJudges) {
        subjectJudgeDao.insertBatch(subjectJudges);
    }

    @Override
    public SubjectJudge queryByCondition(SubjectJudge subjectJudge) {
        return subjectJudgeDao.queryByCondition(subjectJudge);
    }
}
