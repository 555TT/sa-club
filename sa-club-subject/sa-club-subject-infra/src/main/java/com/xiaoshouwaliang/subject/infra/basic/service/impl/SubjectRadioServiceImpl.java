...
import com.xiaoshouwaliang.subject.infra.basic.mapper.SubjectRadioDao;
...
public class SubjectRadioServiceImpl implements SubjectRadioService {
    ...
    @Override
    public void batchInsert(LinkedList<SubjectRadio> radios) {
        subjectRadioDao.insertBatch(radios);
    }

    @Override
    public List<SubjectRadio> queryByCondition(SubjectRadio subjectRadio) {
        return subjectRadioDao.queryByCondition(subjectRadio);
    }
}
