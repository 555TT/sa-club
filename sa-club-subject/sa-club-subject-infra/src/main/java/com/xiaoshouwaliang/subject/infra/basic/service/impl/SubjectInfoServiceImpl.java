...
import com.xiaoshouwaliang.subject.infra.basic.mapper.SubjectInfoDao;
...
public class SubjectInfoServiceImpl implements SubjectInfoService {
    ...
    @Override
    public int queryCount(SubjectInfo subjectInfo,Long categoryId,Long labelId) {
        return subjectInfoDao.queryCount(subjectInfo,categoryId,labelId);
    }
