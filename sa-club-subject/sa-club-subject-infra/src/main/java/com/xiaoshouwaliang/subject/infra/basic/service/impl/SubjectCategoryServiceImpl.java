...
import com.xiaoshouwaliang.subject.infra.basic.mapper.SubjectCategoryDao;
...
public class SubjectCategoryServiceImpl implements SubjectCategoryService {
    ...
    public List<SubjectCategory> queryCategory(SubjectCategory subjectCategory) {
        List<SubjectCategory> categoryList =subjectCategoryDao.queryCategory(subjectCategory);
        return categoryList;
    }
}
