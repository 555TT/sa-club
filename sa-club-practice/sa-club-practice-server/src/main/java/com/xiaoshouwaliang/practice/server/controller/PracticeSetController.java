...
import com.xiaoshouwaliang.practice.api.common.Result;
...
public class PracticeSetController {
    ...
    public Result<SpecialPracticeVO> getSpecialPracticeContent(){
        try {
            return Result.ok(practiceSetService.getSpecialPracticeContent());
        } catch (Exception e) {
            log.error("PracticeSetController.getSpecialPracticeContent.error:{}",e.getMessage());
            return Result.fail("获取专项练习信息失败");
        }
    }
